...
public class Animasyonlar {
    ...
    public static void butonlarAnimasyonu(List<View> butonlar) {
        ...
        ObjectAnimator objectAnimator2=ObjectAnimator.ofInt(butonlar.get(1),"translationY",600,0);
        ObjectAnimator objectAnimator3=ObjectAnimator.ofInt(butonlar.get(2),"translationY",700,0);
        ObjectAnimator objectAnimator4=ObjectAnimator.ofInt(butonlar.get(3),"translationY",800,0);

        objectAnimator.setDuration(1250);
        objectAnimator2.setDuration(1500);
        objectAnimator3.setDuration(1750);
    ...
    public static void titremeAnimasyonu(RelativeLayout soruContainer) {
        ...
        ObjectAnimator animator=ObjectAnimator.ofFloat(soruContainer,"traslationX",-40,40,-30,30,-20,20,0);
